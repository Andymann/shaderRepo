/*
{
    ...
    "DESCRIPTION": "Automatically converted from http://glslsandbox.com/e#72062.3",
    "INPUTS": [
    ]
}
...
h.x = min(h.x,h2.x);
    ...
    vec3 shapecol = vec3(0.2, 0.15, 0.15)*1.5;
    vec3 shapecol2 = vec3(1.,.5,.3) * 3.0;
