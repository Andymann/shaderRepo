/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#51574.0"
}
*/
...
vec3 Flag2enh( vec2 p)
{
	...
	p /= 0.43;
	if(length(p) >= 1.0)
		return vec3(1.,0.6,0.9);//changed this to pink, b/c wtf, you really had to add a swastika?
