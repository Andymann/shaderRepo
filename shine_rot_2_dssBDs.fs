/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/dssBDs by chenxianming.  original creation clip design source free for download\nhttp://benchart.cn/whirl_1170x2532@x2_60fps.mp4",
    "IMPORTED": {
    },
    "INPUTS": [
    ]
...
void main() {
    ...
    vec2 a=gl_FragCoord.xy/RENDERSIZE.xy;
    a=(a-.5)*2.,a.x*=RENDERSIZE.x/RENDERSIZE.y;
