/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#46691.0"
}
*/
...
void main( void ) {
    ...
    vec3 rnd = hash33(vec3(gl_FragCoord.xy, TIME/60.));
    ...
    vec3 from = forward*TIME*4.0;
    
    float focal = 4.0;
    float sinPix = sin(FOV / RENDERSIZE.y);
    ...
    gl_FragColor.rgb = filmicToneMapping(acc.rgb);
    gl_FragColor.a = 1.0;
