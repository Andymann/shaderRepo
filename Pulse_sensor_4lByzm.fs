/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4lByzm by A2K.  ECG",
  "INPUTS" : [
...
void main() {
    ...
    float light = 3.0;
    float noise = 0.1 * rand(floor(fract(TIME * 0.1) * 10.0));
    ...
    vec2 tuv = vec2(Time * RENDERSIZE.x / RENDERSIZE.y, (waveform(Time * 1.1 + 0.2) + 1.5) / 4.0);
