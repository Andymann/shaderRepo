/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#54036.0",
  "INPUTS" : [
    {
      "NAME" : "heartCount",
      "TYPE" : "float",
...
/*
 * Original shader from: https://www.shadertoy.com/view/ttsGzn
 */
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    for(float i=0.; i<1.; i+=(1./heartCount)) {
