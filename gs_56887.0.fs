/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#56887.0"
}
*/
...
vec3 hearts(vec2 polar, float TIME, float fft) {
    ...
    vec3 heartCol = vec3(smoothstep(0., -.05, heartDist), 0., 0.) * a + heartGlow * vec3(COL_RED, COL_GREEN, COL_BLU);
