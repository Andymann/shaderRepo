/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#54126.0"
}
*/
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	fragColor.rgb=mix(texture(iChannel0,rd).rgb*.0,mix(c,texture(iChannel0,rd).rgb,0.01+0.2*dot(c,vec3(1.0/3.0))),step(d,1e2));
