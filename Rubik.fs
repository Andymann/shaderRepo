/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#51532.0"
}
*/
...
void main( void ) {
	...
	vec2 uv = (gl_FragCoord.xy - RENDERSIZE*.5)/RENDERSIZE.y*.5;
	...
	colour += 01.-min(01.,float(FRAMES)-tf);
