/*
{
    ...
    "DESCRIPTION": "Automatically converted from http://glslsandbox.com/e#66704.0",
    "INPUTS": [
        {
            "MAX": [
                1,
...
#define MIN_DIST (.5/max(RENDERSIZE.x, RENDERSIZE.y))
#define MAX_DIST 3.0
...
void main( void ) 
{
	vec2 aspect 	= RENDERSIZE / RENDERSIZE.y;
