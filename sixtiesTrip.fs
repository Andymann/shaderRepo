/*
{
  ...
  "DESCRIPTION": "Automatically converted from http://glslsandbox.com/e#26468.0",
  "INPUTS": [
    {
      "MAX": [
        1,
...
void main( void ) {
  gl_FragColor = 
    rainbowJam(infundibularize(pentaplexify(perturbedNewton(3.*(2.*gl_FragCoord.xy-RENDERSIZE.xy) / RENDERSIZE.y)))
  + 0.4*(mouse.xy-0.5)
  + TIME * -0.2);
}