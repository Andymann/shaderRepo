/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https:\/\/www.shadertoy.com\/view\/4lSBzm by Shane.  Mapping a square Truchet pattern onto an overlapping, interwoven hexagonal Truchet object.",
  "INPUTS" : [
...
vec2 hash22(vec2 p) { 
    ...
    return sin( p*6.2831853 + TIME )*.5 + .5; 
	*/
...
void main() {
	...
	// Camera Setup.
	vec3 lk = vec3(0, 0, TIME*1.);  // "Look At" position.
    ...
    // Vignette.
    u = gl_FragCoord.xy/RENDERSIZE.xy;
