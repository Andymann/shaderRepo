/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#61311.0"
}
*/


/*
 * Original shader from: https://www.shadertoy.com/view/4sSBRy
 */
...
vec3 color(vec2 uv_s)
{
    ...
    int i = 0;
    for(int ii = 0; ii < nbIterations ; ii++)
    {
        Tri_TMP.ID2 *= 5.;
