/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#46275.0"
}
*/
...
void main(void){vec2 uv=(gl_FragCoord.xy-0.5*RENDERSIZE.xy)/RENDERSIZE.y;gl_FragColor=vec4(trace(vec3(0,6,-20),vec3(uv,.4))/FAR);}