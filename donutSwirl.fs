/*
{
  ...
  "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/Xt23z3 by Flyguy.   Classic twister effect applied to a ring.",
  "IMPORTED": [
...
float aaSize = 2.0 / RENDERSIZE.y; //Scale anti aliasing with resolution
...
vec4 slice(float x0, float x1, vec2 uv)
{
    ...
    //Checker board
    uv.y += TIME * SCROLL_SPEED; //Scrolling
