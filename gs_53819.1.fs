/*
{
  ...
  "DESCRIPTION" : "Automatically converted from http:\/\/glslsandbox.com\/e#53819.1"
}
*/


/*
 * Original shader from: https://www.shadertoy.com/view/tsBSzc
 */
...
{
    return (.4+intersectSphere(vec3(ro, 0), vec3(rd, 0), vec3(org, 0), rad)); // oops
}
