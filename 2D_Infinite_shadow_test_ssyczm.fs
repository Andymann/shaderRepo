/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/ssyczm by amagitakayosi.  Infinite shadow can be drawn easily if the shape is defined as SDF.",
    "IMPORTED": {
    },
    "INPUTS": [
    ]
...
void main() {
    ...
    vec2 p = uv * 2. - 1.;
    p.x *= RENDERSIZE.x / RENDERSIZE.y; // fix aspect ratio
    vec3 col;
